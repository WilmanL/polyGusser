...
def get_db():
    try:
        ...
        userBioSchemaCollection = db["userBioSchema"]
        return (contextoCollection, userGuessCollection, leaderboardCollection, userLoginCollection, wallSchemaCollection, userBioSchemaCollection)
