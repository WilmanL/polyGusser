    ...
    <div className="card shadow-sm mb-4">
        <div className="card-body">
            ...
            <div className="row no-gutters d-none d-lg-flex">
                ...
                <img src={'https://picsum.photos/800/1000'} onError={(e)=>{e.target.onerror = null; e.target.src=testImage}} alt="img" width="80px" height="80px" className="rounded-circle mb-4" />
                <img src={'https://picsum.photos/800/1000'} onError={(e)=>{e.target.onerror = null; e.target.src=testImage}} alt="img" width="80px" height="80px" className="rounded-circle" />
                </div>
